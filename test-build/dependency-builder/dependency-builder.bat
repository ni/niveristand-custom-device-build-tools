...
echo "Building in LabVIEW 2027 32-bit..."
LabVIEWCLI ^
  -PortNumber 3363 ^
  -LabVIEWPath "C:\Program Files (x86)\National Instruments\LabVIEW 2027\LabVIEW.exe" ^
  -AdditionalOperationDirectory "%cd%\..\..\lv\operations" ^
  -OperationName "ExecuteAllBuildSpecs" ^
  -ProjectPath "%cd%\DependencyBuilder.lvproj"
taskkill /im labview.exe /f
...
echo "Creating directories for library 1..."
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.1\2027\x86\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.1\2027\x86\Linux_x64"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x86\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x86\Linux_x64"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.3\2027\x86\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.3\2027\x86\Linux_x64"
copy "output\Windows\DependencyLibrary1.lvlibp" "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x86\Windows"
copy "output\Linux_x64\DependencyLibrary1.lvlibp" "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x86\Linux_x64"
...
echo "Building in LabVIEW 2027 64-bit..."
LabVIEWCLI ^
  -PortNumber 3363 ^
  -LabVIEWPath "C:\Program Files\National Instruments\LabVIEW 2027\LabVIEW.exe" ^
  -AdditionalOperationDirectory "%cd%\..\..\lv\operations" ^
  -OperationName "ExecuteAllBuildSpecs" ^
  -ProjectPath "%cd%\DependencyBuilder.lvproj"
taskkill /im labview.exe /f
...
echo "Creating directories for library 1..."
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.1\2027\x64\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.1\2027\x64\Linux_x64"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x64\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x64\Linux_x64"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.3\2027\x64\Windows"
mkdir "%cd%\dependency-test-1\ni\export\main\12345678.3\2027\x64\Linux_x64"
copy "output\Windows\DependencyLibrary1.lvlibp" "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x64\Windows"
copy "output\Linux_x64\DependencyLibrary1.lvlibp" "%cd%\dependency-test-1\ni\export\main\12345678.2\2027\x64\Linux_x64"
