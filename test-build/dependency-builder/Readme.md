...
To build the dependencies, you can use dependency-builder.bat on a system with LabVIEW 2023, LabVIEW 2024, LabVIEW 2025, LabVIEW 2026 and LabVIEW 2027.  It will generate exports in dependency-test that can be copied into nirvana as desired.