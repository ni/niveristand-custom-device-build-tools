...
<Library LVVersion="15008000">
	...
	<Item Name="Append Method.ctl" Type="VI" URL="../Append Method.ctl"/>
	<Item Name="convert.exe" Type="Document" URL="../convert.exe"/>
	<Item Name="ImageMagic Append Wrapper.vi" Type="VI" URL="../ImageMagic Append Wrapper.vi"/>
	<Item Name="ImageMagic Label Wrapper.vi" Type="VI" URL="../ImageMagic Label Wrapper.vi"/>
	<Item Name="ImageMagick-6.8.8-7-Q16-x86-windows.txt" Type="Document" URL="../ImageMagick-6.8.8-7-Q16-x86-windows.txt"/>
	<Item Name="Label Position.ctl" Type="VI" URL="../Label Position.ctl"/>
	<Item Name="License.txt" Type="Document" URL="../License.txt"/>
	<Item Name="vcomp100.dll" Type="Document" URL="../vcomp100.dll"/>
</Library>
